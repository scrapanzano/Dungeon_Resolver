(define (problem instance_30_1229)
  ...
  (:objects
    ...
    P0 P1 P2 P3 P4 P5 P6 P7 P8 - potion 
  )
  ...
  (:init
    ...
    (room_safe R0) (room_safe R2) (room_safe R3) (room_safe R4) (room_safe R7) (room_safe R9) (room_safe R10) (room_safe R11) (room_safe R12) (room_safe R13) (room_safe R19) (room_safe R20) (room_safe R21) (room_safe R22) (room_safe R23) (room_safe R27) (room_safe R28) (room_safe R29)  
    ...
    (enemy_at E0 R1) (enemy_at E1 R25) (enemy_at E2 R8) (enemy_at E3 R24) (enemy_at E4 R18) (enemy_at E5 R16) (enemy_at E6 R17) (enemy_at E7 R15) (enemy_at E8 R6) (enemy_at E9 R14) (enemy_at E10 R26) (enemy_at E11 R5)  
    (= (enemy_life E0) 30) (= (enemy_life E1) 30) (= (enemy_life E2) 90) (= (enemy_life E3) 30) (= (enemy_life E4) 90) (= (enemy_life E5) 90) (= (enemy_life E6) 90) (= (enemy_life E7) 70) (= (enemy_life E8) 90) (= (enemy_life E9) 70) (= (enemy_life E10) 30) (= (enemy_life E11) 70)  
    (= (enemy_strength E0) 30) (= (enemy_strength E1) 30) (= (enemy_strength E2) 90) (= (enemy_strength E3) 30) (= (enemy_strength E4) 90) (= (enemy_strength E5) 90) (= (enemy_strength E6) 90) (= (enemy_strength E7) 70) (= (enemy_strength E8) 90) (= (enemy_strength E9) 70) (= (enemy_strength E10) 30) (= (enemy_strength E11) 70) 
    ;Weapons position and strength
    (weapon_at W0 R22) (weapon_at W1 R19) (weapon_at W2 R11) (weapon_at W3 R21) (weapon_at W4 R28) (weapon_at W5 R20) (weapon_at W6 R12) (weapon_at W7 R29) (weapon_at W8 R2) (weapon_at W9 R27) (weapon_at W10 R7) (weapon_at W11 R4)  
    (= (weapon_strength W0) 30) (= (weapon_strength W1) 30) (= (weapon_strength W2) 90) (= (weapon_strength W3) 30) (= (weapon_strength W4) 90) (= (weapon_strength W5) 90) (= (weapon_strength W6) 90) (= (weapon_strength W7) 70) (= (weapon_strength W8) 90) (= (weapon_strength W9) 70) (= (weapon_strength W10) 30) (= (weapon_strength W11) 70) 
    ;Potions position and value
    (potion_at P0 R18) (potion_at P1 R1) (potion_at P2 R13) (potion_at P3 R9) (potion_at P4 R8) (potion_at P5 R10) (potion_at P6 R27) (potion_at P7 R24) (potion_at P8 R6)  
    (= (potion_value P0) 30) (= (potion_value P1) 50) (= (potion_value P2) 50) (= (potion_value P3) 10) (= (potion_value P4) 10) (= (potion_value P5) 30) (= (potion_value P6) 30) (= (potion_value P7) 50) (= (potion_value P8) 50)  
    ;Hero initial stats 
    (= (hero_life) 100)
    (= (max_hero_life) 100)
    (= (hero_strength) 0)
