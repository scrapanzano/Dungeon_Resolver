(define (problem instance_30_42)
  ...
  (:init
    ...
    (= (key_counter) 0)
    (treasure_at T0 R4) (treasure_at T1 R6) (treasure_at T2 R10) (treasure_at T3 R12) (treasure_at T4 R15) (treasure_at T5 R24) (treasure_at T6 R27) (treasure_at T7 R28) (treasure_at T8 R29) 
    ( = (treasure_value T0) 19) ( = (treasure_value T1) 16) ( = (treasure_value T2) 16) ( = (treasure_value T3) 17) ( = (treasure_value T4) 18) ( = (treasure_value T5) 3) ( = (treasure_value T6) 8) ( = (treasure_value T7) 2) ( = (treasure_value T8) 2) 
    (= (hero_loot) 0)
  )
